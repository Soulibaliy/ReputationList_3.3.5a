...
local Translations = {
    ["ruRU"] = {
		...
		["BLACKLIST_DAL"] = " - Даларан - ЧС - до свидания",
		["BLACKLIST_DAL2"] = "отправлен в Даларан",
		["BLACKLIST_BL2"] = " - в черном списке Blizzard",
		
		["INFO_R01"] = "|cFFFF0000[RepList]|r КОНФЛИКТ: Обнаружен другой игрок с ником '",
		["INFO_R02"] = "|cFFFF0000Ожидался GUID: ",
		["INFO_R03"] = "|cFFFF0000Получен GUID: ",
		["INFO_R04"] = "|cFFFF0000Старая запись сохранена. Добавьте нового игрока вручную если нужно.|r",
		["INFO_R05"] = "|cFFFFAA00Обновляю запись вместо создания дубликата|r",
		...
		["UI_CB66_1"] = "|cFFFFFF00/rlist kick target|r - Исключить цель из группы и добавить в Blacklist",
		...
		["UI_CB85"] = "|cFFFFFF00/rlclearwho или /rlочистить|r - Очистить список 'Кто здесь?'",
		["WH_D01"] = "|cFFFF0000ReputationList:|r Нет данных о группе/рейде. Сначала вступите в группу или рейд.",
		["WH_D02"] = "|cFFFFAA00ReputationList:|r Показываются данные последней группы/рейда.",
		["WH_D03"] = "Кто здесь?",
		["WH_D04"] = "Показать игроков в текущей группе/рейде",
		["UI_POP_GROUP"] = "Информация - В группе/рейде",
		["WH_SV"] = "|cFF00FF00ReputationList:|r Ссылка сохранена для ",
		["WH_D05"] = "|cFFFF0000ReputationList:|r Вы не являетесь лидером группы/рейда и не можете исключить игрока.",
		["WH_D06"] = "|cFFFF0000ReputationList:|r Ошибка: данные игрока не найдены",
		["WH_D07"] = "|cFFFFFF00Ссылка в ЛК:|r",
		["UI_ADDED_FROM_GROUP"] = "Добавлен из группы",
		["WH_D08"] = "|cFFFFAA00Перемещение из ",
		["WH_D09"] = " в ",
		["WH_D10"] = " обновлён в ",
		["WH_D11"] = "|cFF00FF00ReputationList:|r Игрок ",
		["WH_W01"] = "|cFFFF0000ReputationList:|r Аддон Blacklist не найден или не загружен",
		["WH_W02"] = "|cFFFF0000ReputationList:|r Аддон Elitist не найден или не загружен",
		["WH_W03"] = "|cFFFF0000ReputationList:|r Аддон IgnoreMore не найден или не содержит данных",
		["WH_W04"] = "|cFF00FF00ReputationList:|r Миграция завершена! Данные перенесены на realm: ",
		["WH_W05"] = "|cFFFFAA00ReputationList:|r UI модуль не найден.",
		["WH_W06"] = "|cFFFF0000ReputationList:|r Неизвестная команда. Используйте /rlist help",
		["WH_W07"] = "|cFFFF0000[RepList]|r КОНФЛИКТ GUID: В базе уже есть игрок с ником '",
		["WH_W08"] = "|cFFFF0000Старый GUID: ",
		["WH_W09"] = "|cFFFF0000Новый GUID: ",
		["WH_W10"] = "|cFFFFAA00Старая запись переименована в: ",
		["WH_W11"] = "|cFFFFAA00При следующей встрече со старым игроком его ник обновится автоматически.|r",
		["WH_W12"] = "|cFFFFAA00Новый игрок '",
		["WH_W13"] = "' будет добавлен.|r",
		["WH_W14"] = "|cFF00FF00ReputationList:|r Игрок ",
		["WH_W15"] = " добавлен в ",
		["WEM01"] = "|cFFFF9900[RepList]|r ВНИМАНИЕ: Обнаружен новый игрок с ником '",
		["WEM02"] = "|cFFFF9900Старый игрок остался в ",
		["WEM03"] = ", новый добавлен в ",
		["WEM04"] = " удален из ",
		["WEM05"] = " не найден в ",
		["WEM06"] = "|cFFFF0000ReputationList:|r Цель не является игроком или не выбрана.",
		["WEM07"] = "|cFFFF0000ReputationList:|r Использование: /rlist kick target или /rlist kick [Имя]",
		["WEM08"] = " не находится в вашей группе/рейде.",
		["WEM09"] = "Исключен через команду kick",
		["WEM10"] = " исключен из рейда и добавлен в Blacklist.",
		...
		["WEM18"] = "|cFF00FF00ReputationList:|r Оповещение себе в ЛС |cFF00FF00включено|r",
		["WEM19"] = "|cFFFF0000ReputationList:|r Оповещение себе в ЛС |cFFFF0000выключено|r",
		["WEM20"] = "|cFF00FF00ReputationList:|r Окрашивание LFG |cFF00FF00включено|r",
		["WEM21"] = "|cFFFF0000ReputationList:|r Окрашивание LFG |cFFFF0000выключено|r",
		["WEM22"] = "|cFF00FF00ReputationList:|r Звук и всплывающие окна |cFF00FF00включены|r",
		["WEM23"] = "|cFFFF0000ReputationList:|r Звук и всплывающие окна |cFFFF0000выключены|r",
		["WEM24"] = "|cFF00FF00ReputationList:|r Попытка исключить ",
		["WEM25"] = " из группы",
		["WEM26"] = " из рейда (индекс: ",
		["WEM27"] = "|cFFFF0000Blacklist: В ЧС Blizzard|r",
		["WEM28"] = "|cFFFF0000[RepList]|r КОНФЛИКТ при наведении: Игрок '",
		["WEM29"] = "' имеет другой GUID!",
		["WEM30"] = "|cFF00FF00Reputation List:|r иконка миникарты восстановлена.",
		["WEM31"] = "|cFFFFAA00Reputation List:|r иконка показана, но позиция может быть неверной.",
		["WEM32"] = "|cFFFFAA00Используйте ПКМ для перемещения или /reload для сброса.|r",
		["WEM33"] = "|cFFFF0000Reputation List:|r иконка миникарты ещё не создана.",
		["WEM34"] = "|cFFFFAA00Настройки сохранены. Выполните /reload или перезайдите.|r",
		["WEM35"] = "ВНИМАНИЕ! Игрок из ЧЕРНОГО СПИСКА [",
		["WEM36"] = "] пишет вам: ",
		["WEM37"] = "|r пишет вам!",
		["WEM38"] = "|cFFFF0000[RepList]|r Заблокирован трейд от игрока из ЧС: ",
		["WEM39"] = "|cFFFF0000[RepList]|r Обнаружен трейд от игрока из ЧС: ",
        ...
        ["HIST_BTN"] = "История",
        ["HIST_BACK_BTN"] = "О персонаже",
        ["HIST_TITLE"] = "История записи",
        ["HIST_PLAYER"] = "Игрок:",
        ["HIST_ADDED_SECTION"] = "Добавление в список",
        ["HIST_ADDED_DATE"] = "Дата добавления:",
        ["HIST_ADDED_BY"] = "Добавил(а) персонаж:",
        ["HIST_ADDED_REALM"] = "Реалм:",
        ["HIST_ADDED_DATA"] = "Данные на момент добавления:",
        ["HIST_LAST_SEEN"] = "Последняя проверка:",
        ["HIST_UPDATES_SECTION"] = "Обновления",
        ["HIST_LAST_UPDATE"] = "Последнее обновление:",
        ["HIST_NO_UPDATES"] = "Обновлений не было",
        ["HIST_NO_DATA"] = "Нет данных - игрок не добавлен в список",
        ["HIST_UNKNOWN"] = "неизвестно",
        ["HIST_CLASS"] = "Класс:",
        ["HIST_RACE"] = "Раса:",
        ["HIST_LEVEL"] = "Уровень:",
        ["HIST_GUILD"] = "Гильдия:",
        ["HIST_FACTION"] = "Фракция:",
        ["HIST_CHANGE_NAME"] = "Ник изменён:",
        ["HIST_CHANGE_CLASS"] = "Класс изменён:",
        ["HIST_CHANGE_RACE"] = "Раса изменена:",
        ["HIST_CHANGE_LEVEL"] = "Уровень изменён:",
        ["HIST_CHANGE_GUILD"] = "Гильдия изменена:",
        ["HIST_CHANGE_FACTION"] = "Фракция изменена:",
        ["HIST_CHANGE_GUID_LINKED"] = "Привязан GUID персонажа",
        ["HIST_CHANGE_NOTE"] = "Изменена заметка",
        ["HIST_CHANGE_ARMORY"] = "Обновлена ссылка Armory",
        ["HIST_BY"] = "автор:",
    },
    ...
    ["enUS"] = {
		...
		["BLACKLIST_DAL"] = "Dalaran - Blacklist - goodbye",
		["BLACKLIST_DAL2"] = "sent to Dalaran",
		["BLACKLIST_BL2"] = " - in Blizzard's blacklist",

		["INFO_R01"] = "|cFFFF0000[RepList]|r CONFLICT: Found another player with name '",
		["INFO_R02"] = "|cFFFF0000Expected GUID: ",
		["INFO_R03"] = "|cFFFF0000Received GUID: ",
		["INFO_R04"] = "|cFFFF0000Old entry saved. Add new player manually if needed.|r",
		["INFO_R05"] = "|cFFFFAA00Updating entry instead of creating duplicate|r",
		...
		["UI_CB66_1"] = "|cFFFFFF00/rlist kick target|r - Kick target from group and add to Blacklist",
		...
		["UI_CB85"] = "|cFFFFFF00/rlclearwho|r - Clear 'Who's Here?' list",
		["WH_D01"] = "|cFFFF0000ReputationList:|r No group/raid data. Join a group or raid first.",
		["WH_D02"] = "|cFFFFAA00ReputationList:|r Showing last group/raid data.",
		["WH_D03"] = "Who is here?",
		["WH_D04"] = "Show players in current group/raid",
		["UI_POP_GROUP"] = "Information - In group/raid",
		["WH_SV"] = "|cFF00FF00ReputationList:|r Link saved for ",
		["WH_D05"] = "|cFFFF0000ReputationList:|r You are not the group/raid leader and cannot remove a player.",
		["WH_D06"] = "|cFFFF0000ReputationList:|r Error: player data not found",
		["WH_D07"] = "|cFFFFFF00Armory link:|r",
		["UI_ADDED_FROM_GROUP"] = "Added from group",
		["WH_D08"] = "|cFFFFAA00Moving from ",
		["WH_D09"] = " to ",
		["WH_D10"] = " updated in ",
		["WH_D11"] = "|cFF00FF00ReputationList:|r Player ",
		["WH_W01"] = "|cFFFF0000ReputationList:|r Blacklist addon not found or not loaded",
		["WH_W02"] = "|cFFFF0000ReputationList:|r Elitist addon not found or not loaded",
		["WH_W03"] = "|cFFFF0000ReputationList:|r IgnoreMore addon not found or contains no data",
		["WH_W04"] = "|cFF00FF00ReputationList:|r Migration completed! Data transferred to realm: ",
		["WH_W05"] = "|cFFFFAA00ReputationList:|r UI module not found.",
		["WH_W06"] = "|cFFFF0000ReputationList:|r Unknown command. Use /rlist help",
		["WH_W07"] = "|cFFFF0000[RepList]|r GUID CONFLICT: Database already has a player with name '",
		["WH_W08"] = "|cFFFF0000Old GUID: ",
		["WH_W09"] = "|cFFFF0000New GUID: ",
		["WH_W10"] = "|cFFFFAA00Old entry renamed to: ",
		["WH_W11"] = "|cFFFFAA00Next time you meet the old player, their name will update automatically.|r",
		["WH_W12"] = "|cFFFFAA00New player '",
		["WH_W13"] = "' will be added.|r",
		["WH_W14"] = "|cFF00FF00ReputationList:|r Player ",
		["WH_W15"] = " added to ",
		["WEM01"] = "|cFFFF9900[RepList]|r WARNING: Found new player with name '",
		["WEM02"] = "|cFFFF9900Old player remains in ",
		["WEM03"] = ", new player added to ",
		["WEM04"] = " removed from ",
		["WEM05"] = " not found in ",
		["WEM06"] = "|cFFFF0000ReputationList:|r Target is not a player or not selected.",
		["WEM07"] = "|cFFFF0000ReputationList:|r Usage: /rlist kick target or /rlist kick [Name]",
		["WEM08"] = " is not in your group/raid.",
		["WEM09"] = "Kicked via kick command",
		["WEM10"] = " kicked from raid and added to Blacklist.",
		...
		["WEM18"] = "|cFF00FF00ReputationList:|r Whisper self-notification |cFF00FF00enabled|r",
		["WEM19"] = "|cFFFF0000ReputationList:|r Whisper self-notification |cFFFF0000disabled|r",
		["WEM20"] = "|cFF00FF00ReputationList:|r LFG coloring |cFF00FF00enabled|r",
		["WEM21"] = "|cFFFF0000ReputationList:|r LFG coloring |cFFFF0000disabled|r",
		["WEM22"] = "|cFF00FF00ReputationList:|r Sound and popups |cFF00FF00enabled|r",
		["WEM23"] = "|cFFFF0000ReputationList:|r Sound and popups |cFFFF0000disabled|r",
		["WEM24"] = "|cFF00FF00ReputationList:|r Attempting to kick ",
		["WEM25"] = " from group",
		["WEM26"] = " from raid (index: ",
		["WEM27"] = "|cFFFF0000Blacklist: In Blizzard's Blacklist|r",
		["WEM28"] = "|cFFFF0000[RepList]|r CONFLICT on hover: Player '",
		["WEM29"] = "' has different GUID!",
		["WEM30"] = "|cFF00FF00Reputation List:|r minimap icon restored.",
		["WEM31"] = "|cFFFFAA00Reputation List:|r minimap icon shown, but position may be incorrect.",
		["WEM32"] = "|cFFFFAA00Use Right-Click to move or /reload to reset.|r",
		["WEM33"] = "|cFFFF0000Reputation List:|r minimap icon not created yet.",
		["WEM34"] = "|cFFFFAA00Settings saved. Please /reload or relog.|r",
		["WEM35"] = "WARNING! Player from BLACKLIST [",
		["WEM36"] = "] whispers you: ",
		["WEM37"] = "|r whispers you!",
		["WEM38"] = "|cFFFF0000[RepList]|r Blocked a trade from blacklisted player: ",
		["WEM39"] = "|cFFFF0000[RepList]|r Detected a trade from blacklisted player: ",
        ...
        ["HIST_BTN"] = "History",
        ["HIST_BACK_BTN"] = "Player info",
        ["HIST_TITLE"] = "Entry History",
        ["HIST_PLAYER"] = "Player:",
        ["HIST_ADDED_SECTION"] = "Added to list",
        ["HIST_ADDED_DATE"] = "Date added:",
        ["HIST_ADDED_BY"] = "Added from character:",
        ["HIST_ADDED_REALM"] = "Realm:",
        ["HIST_ADDED_DATA"] = "Data at time of adding:",
        ["HIST_LAST_SEEN"] = "Last checked:",
        ["HIST_UPDATES_SECTION"] = "Updates",
        ["HIST_LAST_UPDATE"] = "Last update:",
        ["HIST_NO_UPDATES"] = "No updates yet",
        ["HIST_NO_DATA"] = "No data - player is not on the list",
        ["HIST_UNKNOWN"] = "unknown",
        ["HIST_CLASS"] = "Class:",
        ["HIST_RACE"] = "Race:",
        ["HIST_LEVEL"] = "Level:",
        ["HIST_GUILD"] = "Guild:",
        ["HIST_FACTION"] = "Faction:",
        ["HIST_CHANGE_NAME"] = "Name changed:",
        ["HIST_CHANGE_CLASS"] = "Class changed:",
        ["HIST_CHANGE_RACE"] = "Race changed:",
        ["HIST_CHANGE_LEVEL"] = "Level changed:",
        ["HIST_CHANGE_GUILD"] = "Guild changed:",
        ["HIST_CHANGE_FACTION"] = "Faction changed:",
        ["HIST_CHANGE_GUID_LINKED"] = "Character GUID linked",
        ["HIST_CHANGE_NOTE"] = "Note edited",
        ["HIST_CHANGE_ARMORY"] = "Armory link updated",
        ["HIST_BY"] = "by:",
    }
}
...
local SettingsTranslations = {
    ruRU = {
        ...
        SET_SECTION_SYNC = "Синхронизация",
        SET_DISABLE_SYNC = "Полностью отключить синхронизацию",
        SET_DISABLE_SYNC_HINT = "Аддон не будет принимать и отправлять пакеты синхронизации. Накопленные входящие передачи и предложения будут удалены.",
    ...
    enUS = {
        ...
        SET_SECTION_SYNC = "Synchronization",
        SET_DISABLE_SYNC = "Disable synchronization completely",
        SET_DISABLE_SYNC_HINT = "The addon will neither receive nor send synchronization packets. Buffered incoming transfers and pending suggestions will be cleared.",
